...
public class GeneralTest {
	...
	public void testProject() {
		...
		try {
			new Project("AA", "BB", 10, 100l, o, c);
			new Project("AA", "BB", 1, 1l, o, c);
		} catch (InvalidDataException e) {
			fail("error in project");
		}

		try {
			new Project(null, "BB", 1, 1l, o, c);
			fail("project allowed null acronym");
		} catch (InvalidDataException e) {
		}

		try {
			new Project("AA", null, 1, 1l, o, c);
			fail("project allowed null description");
		} catch (InvalidDataException e) {
		}

		try {
			new Project("AA", "DD", -1, 1l, o, c);
		...
		try {
			new Project("AA", "DD", 1, 1l, null, c);
			fail("project allowed null owner ");
		} catch (InvalidDataException e) {
		}

		try {
			new Project("AA", "DD", 1, 1l, o, null);
	...
	public void testEvaluation() {
		...
		try {
			Project po = new Project("AA", "BB", 10, 100l, ow, ca);
	...
	public void testProjectDB() {
		...
		try {
			...
			Project p = new Project("A", "B", 10, 1l, o, c);
